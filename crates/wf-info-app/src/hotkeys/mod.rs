...
use wf_info_core::{platform::GlobalShortcutBackend, AppSettings, ScanKind};
...
pub(crate) fn has_system_shortcut_configuration() -> bool {
    wf_info_core::platform::current().global_shortcut_backend()
        ...
        match config {
            ...
            HotkeyWatcherConfig::SystemConfigured {
                ...
                let settings = AppSettings {
                    hotkeys: wf_info_core::HotkeySettings {
                        reward_scan,
                        inventory_scan,
                    },
                };
